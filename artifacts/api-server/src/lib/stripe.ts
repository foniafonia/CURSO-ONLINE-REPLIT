// Stripe Replit integration — do not cache the client, always get fresh credentials
...
// WARNING: Never cache this client — always call this function to get a fresh one.
